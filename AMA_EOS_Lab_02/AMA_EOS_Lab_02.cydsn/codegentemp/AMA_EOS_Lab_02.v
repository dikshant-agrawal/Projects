...
module top ;
	...
	cy_clock_v1_0
		#(.id("34d26f5b-534c-4cd8-8e64-e476304b1655"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
    ...
    PWM_v3_30_5 PWM_red (
        ...
        .tc(Net_2574),
        .trigger(1'b0));
    defparam PWM_red.Resolution = 16;

    PWM_v3_30_6 PWM_yellow (
        .capture(1'b0),
        .clock(Net_604),
        .cmp_sel(1'b0),
        .enable(1'b1),
        ...
        .tc(Net_2514),
        .trigger(1'b0));
    defparam PWM_yellow.Resolution = 16;
