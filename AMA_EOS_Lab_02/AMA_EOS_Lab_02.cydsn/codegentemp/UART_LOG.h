...
#define UART_LOG_TX_BUFFER_SIZE                 (400u)
...
/* Only if TX is enabled */
    ...
    void UART_LOG_PutArray(const uint8 string[], uint16 byteCount)
                                                            ;
    ...
    uint16 UART_LOG_GetTxBufferSize(void)
                                                            ;
    /* Obsolete functions, defines for backward compatible */
...
extern uint8 UART_LOG_initVar;
    ...
    extern volatile uint16 UART_LOG_txBufferRead;
    extern uint16 UART_LOG_txBufferWrite;
