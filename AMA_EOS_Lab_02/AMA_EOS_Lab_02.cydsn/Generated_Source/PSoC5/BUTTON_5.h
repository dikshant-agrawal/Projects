...
*/
     ...
     *  @{
     */
        #define BUTTON_5_INTR_NONE      (uint16)(0x0000u)
        #define BUTTON_5_INTR_RISING    (uint16)(0x0001u)
        #define BUTTON_5_INTR_FALLING   (uint16)(0x0002u)
        #define BUTTON_5_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define BUTTON_5_INTR_MASK      (0x01u) 
#endif /* (BUTTON_5__INTSTAT) */
...
/* SIO registers */
#if defined(BUTTON_5__SIO_CFG)
    #define BUTTON_5_SIO_HYST_EN        (* (reg8 *) BUTTON_5__SIO_HYST_EN)
    #define BUTTON_5_SIO_REG_HIFREQ     (* (reg8 *) BUTTON_5__SIO_REG_HIFREQ)
    #define BUTTON_5_SIO_CFG            (* (reg8 *) BUTTON_5__SIO_CFG)
    #define BUTTON_5_SIO_DIFF           (* (reg8 *) BUTTON_5__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define BUTTON_5_0_INTTYPE_REG 		(* (reg8 *) BUTTON_5__0__INTTYPE)
#endif /* (BUTTON_5__INTSTAT) */
