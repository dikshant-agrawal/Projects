// ======================================================================
// AMA_EOS_Lab_3.v generated from TopDesign.cysch
// 01/26/2026 at 01:06
...
module top ;
    ...
    assign Net_3181 = Net_3182 | Net_3183 | Net_3184 | Net_3185;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_3194),
        .rx_data(Net_3195),
        .rx_interrupt(Net_3196),
        .tx(Net_3197),
        .tx_clk(Net_3198),
        .tx_data(Net_3199),
        .tx_en(Net_3200),
        .tx_interrupt(Net_3201));
    ...
    SPI_Master_v2_50_7 TFT_SPI (
        ...
        .mosi(Net_3287),
        .reset(1'b0),
        .rx_interrupt(Net_3289),
        .sclk(Net_3290),
        .sdat(Net_3291),
        .ss(Net_3292),
        .tx_interrupt(Net_3293));
	...
	wire [0:0] tmpOE__wTFT_SDA_net;
	wire [0:0] tmpFB_0__wTFT_SDA_net;
	wire [0:0] tmpIO_0__wTFT_SDA_net;
	wire [0:0] tmpINTERRUPT_0__wTFT_SDA_net;
	electrical [0:0] tmpSIOVREF__wTFT_SDA_net;

	cy_psoc3_pins_v1_10
		#(.id("7d80a8d3-ab3f-4b1a-9905-79f53884ffaa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		wTFT_SDA
		 (.oe(tmpOE__wTFT_SDA_net),
		  .y({Net_3287}),
		  .fb({tmpFB_0__wTFT_SDA_net[0:0]}),
		  .io({tmpIO_0__wTFT_SDA_net[0:0]}),
		  .siovref(tmpSIOVREF__wTFT_SDA_net),
		  .interrupt({tmpINTERRUPT_0__wTFT_SDA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__wTFT_SDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__wTFT_SCL_net;
	wire [0:0] tmpFB_0__wTFT_SCL_net;
	wire [0:0] tmpIO_0__wTFT_SCL_net;
	wire [0:0] tmpINTERRUPT_0__wTFT_SCL_net;
	electrical [0:0] tmpSIOVREF__wTFT_SCL_net;

	cy_psoc3_pins_v1_10
		#(.id("1978cada-b43b-4c3e-8241-22e09075ad3c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		wTFT_SCL
		 (.oe(tmpOE__wTFT_SCL_net),
		  .y({Net_3290}),
		  .fb({tmpFB_0__wTFT_SCL_net[0:0]}),
		  .io({tmpIO_0__wTFT_SCL_net[0:0]}),
		  .siovref(tmpSIOVREF__wTFT_SCL_net),
		  .interrupt({tmpINTERRUPT_0__wTFT_SCL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__wTFT_SCL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_3286 = 1'h0;
	...
	cy_psoc3_pins_v1_10
		#(.id("dcac4acf-b894-4f34-b520-5c4ec6a8f0e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7c1fd3e6-2a2d-4d77-94ec-67d4f7064eea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4d0d5e0b-c90e-416c-acfc-1c37dd598abd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__wTFT_LED_net;
	wire [0:0] tmpFB_0__wTFT_LED_net;
	wire [0:0] tmpIO_0__wTFT_LED_net;
	wire [0:0] tmpINTERRUPT_0__wTFT_LED_net;
	electrical [0:0] tmpSIOVREF__wTFT_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("38a47370-259a-4107-9274-a7c9ef7d81e0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		wTFT_LED
		 (.oe(tmpOE__wTFT_LED_net),
		  .y({Net_3331}),
		  .fb({tmpFB_0__wTFT_LED_net[0:0]}),
		  .io({tmpIO_0__wTFT_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__wTFT_LED_net),
		  .interrupt({tmpINTERRUPT_0__wTFT_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__wTFT_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("07339bfa-49c6-4d37-95c9-1da10d0c4e14"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("c1a7ad3d-c1e2-4358-a238-62315572694e"),
